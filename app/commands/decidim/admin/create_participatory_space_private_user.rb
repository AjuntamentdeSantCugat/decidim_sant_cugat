      ...
      def existing_user
        Sidekiq.logger.info "
          **********
          ...
          Dentro del existing user antes del return, @existing_user:
          #{@existing_user}
        ...
        Sidekiq.logger.info "
          **********
          ...
          Dentro del existing user, después del find_by:
          #{@existing_user}
        ...
        Sidekiq.logger.info "
          **********
          ...
          Dentro del existing user, después del find_by2:
          #{@existing_user.invitation_accepted?}
