...
namespace :statistics do
  ...
  task by_gender_and_age: :environment do
    ...
    puts "Women => #{percentage_participants_of_zone(total_women_census, total_participants)}"
    puts "Men => #{percentage_participants_of_zone(total_men_census, total_participants)}"
    puts "-----------------------------"

    puts "TOTAL PARTICIPANTS BY GENDER IN 'LA FLORESTA'"
    puts "Women => #{percentage_participants_of_zone(total_women_census, total_participants_la_floresta)}"
    puts "Men => #{percentage_participants_of_zone(total_men_census, total_participants_la_floresta)}"
    puts "-----------------------------"

    puts "TOTAL PARTICIPANTS BY GENDER IN 'MIRA SOL'"
    puts "Women => #{percentage_participants_of_zone(total_women_census, total_participants_mira_sol)}"
    puts "Men => #{percentage_participants_of_zone(total_men_census, total_participants_mira_sol)}"
    puts "-----------------------------"

    puts "TOTAL PARTICIPANTS BY GENDER IN 'LES PLANES'"
    puts "Women => #{percentage_participants_of_zone(total_women_census, total_participants_les_planes)}"
    puts "Men => #{percentage_participants_of_zone(total_men_census, total_participants_les_planes)}"
    puts "-----------------------------"

    puts "TOTAL PARTICIPANTS BY GENDER IN 'CENTRE EST'"
    puts "Women => #{percentage_participants_of_zone(total_women_census, total_participants_centre_est)}"
    puts "Men => #{percentage_participants_of_zone(total_men_census, total_participants_centre_est)}"
    puts "-----------------------------"

    puts "TOTAL PARTICIPANTS BY GENDER IN 'CENTRE OEST'"
    puts "Women => #{percentage_participants_of_zone(total_women_census, total_participants_centre_oest)}"
    puts "Men => #{percentage_participants_of_zone(total_men_census, total_participants_centre_oest)}"
    puts "-----------------------------"

    puts "TOTAL PARTICIPANTS BY GENDER IN 'NUCLI ANTIC'"
    puts "Women => #{percentage_participants_of_zone(total_women_census, total_participants_nucli_antic)}"
    puts "Men => #{percentage_participants_of_zone(total_men_census, total_participants_nucli_antic)}"
    puts "-----------------------------"
